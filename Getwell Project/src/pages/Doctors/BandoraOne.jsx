...
const BandoraOne = () => {
  return (
    ...
    <Container>
        <ImageContainer>
        <ImgCont>
            <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Albert_Bandura_Psychologist.jpg/800px-Albert_Bandura_Psychologist.jpg"/>
            <Name>Bandora</Name>
